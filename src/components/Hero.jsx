    ...
    <section id="inicio" className="hero">
      <div className="container hero__inner">
        <div className="hero__content">
          ...
          <p className="hero__sub">Cuias feitas à mão em cerâmica plástica. Formas, cores e combinações para você escolher de perto.</p>
          ...
          <p className="hero__note">Feitas à mão. Uma a uma.</p>
        </div>
        <figure className="hero__photo">
          ...
          <figcaption>Cor, por todos os lados.</figcaption>
        </figure>
      </div>
    </section>
  )
