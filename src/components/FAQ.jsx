...
const questions = [
  ...
  { question: 'Como posso pagar?', answer: 'Aceitamos Pix, dinheiro e cartão. Dinheiro e cartão valem para quem retira a peça pessoalmente; para envio por motoboy ou transportadora, o pagamento é por Pix. Também dá para reservar uma peça pagando 50% do valor, com o restante pago antes do envio ou da retirada; depois da confirmação do pagamento, a reserva não pode ser cancelada nem reembolsada. Encomendas personalizadas seguem os 50% no início e 50% na finalização.' },
  { question: 'Como funciona o envio?', answer: 'Por motoboy, o valor do frete é calculado por quilômetro a partir de Boa Vista (RR), sem valor mínimo e sem limite de distância. Por transportadora, a cotação é feita conforme o destino e o tamanho da peça, e o código de rastreio é enviado pela DM assim que a peça sai. Nos dois casos, o envio é combinado na DM do Instagram: você manda o endereço, a gente calcula e passa o valor antes de fechar o pedido. Depois do pagamento confirmado, a peça é despachada em cerca de 30 minutos. O frete é pago pelo cliente.' },
